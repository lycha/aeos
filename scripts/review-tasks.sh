...
TASKS=(
  "M1-014-fs-git-commit.md"
  "M2-001-executor-interface.md"
  "M2-002-stub-executor.md"
  "M2-003-claude-cli-executor.md"
  "M2-004-context-assembler.md"
  "M2-005-prompt-builder.md"
  "M2-006-output-validation.md"
  "M2-007-column-spec-zod-schema.md"
  "M2-008-column-spec-loader.md"
  "M2-009-preflight-pass.md"
  "M2-010-cli-ticket-answer.md"
  "M2-011-cli-ticket-run.md"
  "M2-012-cli-ticket-approve.md"
  "M2-013-reviewer-agent-yaml.md"
  "M2-014-claude-cli-smoke-test.md"
  "M3-001-AEOS-1-pm-agent-spec.md"
