...
1. Unzip this file
2. Move the `user-story-writer` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `user-story-writer` folder to `~/.claude/skills/`
...
→ [Full documentation](https://mysecond.ai/skills/user-story-writer)
